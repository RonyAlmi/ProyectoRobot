...
class visual(QDialog):
    def __init__(self):
        ...
        self.manual_but2.clicked.connect(self.control_manual)
...
class tehseencode(QMainWindow):
    ...
    def create_line(self, init, end, color, w):
        ...
        self.MplWidget.canvas.axes.plot(x_values, y_values, color='green')
        # self.MplWidget.canvas.flush_events()
        self.MplWidget.canvas.draw()
    ...
    def onClicked(self):
        ...
        url_1 = 'rtsp://admin:bylogic1234@192.168.1.64/1'
        url_2 = 'rtsp://admin:bylogic1234@192.168.1.65/1'
        url_3 = 'rtsp://admin:bylogic1234@192.168.1.66/1'
        # Abre las cámaras
        try:
